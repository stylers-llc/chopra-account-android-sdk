...
public class SerializedPhpParserException extends Exception
{
     ...
     */
    public static final int TOO_LONG_STRING = 1;

    /**
     * code if serialized string is too short (example: input string is
     * latin1 with special char but assumeUTF8 is set true)
     */
    public static final int TOO_SHORT_STRING = 2;
     ...
     */
    public static final int OUT_OF_RANGE_REFERENCE = 3;
     ...
     */
    public static final int UNEXPECTED_FAILURE = 99;
